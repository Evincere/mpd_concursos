...
VALUES
(1, 'Concurso Defensor/a Penal', 'JURIDICO', 'A', 'Asistencia técnica y representación legal en causas penales', 'DEFENSORIAS PENALES', 'Defensor/a Penal - Primera C.J.', 'ACTIVE', DATE(CURRENT_TIMESTAMP), DATE_ADD(DATE(CURRENT_TIMESTAMP), INTERVAL 30 DAY), '/api/files/contest-bases/contest_1_bases.pdf', '/api/files/contest-bases/contest_1_description.pdf'),
(2, 'Concurso Defensor/a Civil', 'JURIDICO', 'B', 'Asistencia técnica y representación legal en causas civiles', 'DEFENSORIAS CIVILES', 'Defensor/a Civil - Segunda C.J.', 'ACTIVE', DATE(CURRENT_TIMESTAMP), DATE_ADD(DATE(CURRENT_TIMESTAMP), INTERVAL 30 DAY), '/api/files/contest-bases/contest_2_bases.pdf', '/api/files/contest-bases/contest_2_description.pdf'),
(3, 'Concurso Asesor/a Legal', 'JURIDICO', 'C', 'Asesoramiento legal y técnico en materia administrativa', 'SECRETARIA LEGAL Y TECNICA', 'Asesor/a Legal', 'ACTIVE', DATE(CURRENT_TIMESTAMP), DATE_ADD(DATE(CURRENT_TIMESTAMP), INTERVAL 30 DAY), '/api/files/contest-bases/contest_3_bases.pdf', '/api/files/contest-bases/contest_3_description.pdf'),
(4, 'Concurso Analista Programador/a', 'TECNICO', 'D', 'Desarrollo y mantenimiento de sistemas informáticos', 'DESARROLLO TECNOLOGICO', 'Analista Programador/a', 'ACTIVE', DATE(CURRENT_TIMESTAMP), DATE_ADD(DATE(CURRENT_TIMESTAMP), INTERVAL 30 DAY), '/api/files/contest-bases/contest_4_bases.pdf', '/api/files/contest-bases/contest_4_description.pdf'),
(5, 'Concurso Defensor/a de Familia', 'JURIDICO', 'A', 'Asistencia técnica y representación legal en causas de familia', 'CODEFENSORIAS DE FAMILIA', 'Defensor/a de Familia - Primera C.J.', 'ACTIVE', DATE(CURRENT_TIMESTAMP), DATE_ADD(DATE(CURRENT_TIMESTAMP), INTERVAL 30 DAY), '/api/files/contest-bases/contest_5_bases.pdf', '/api/files/contest-bases/contest_5_description.pdf');

-- Insertar documentos de concursos
-- NOTA: Comentado temporalmente para evitar errores de tabla no existente
-- Se agregará después de que la aplicación arranque correctamente
