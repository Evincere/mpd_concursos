...
bars = plt.bar(fechas, valores, color='#4472C4', alpha=0.8)
...
plt.text(len(fechas)/2-1, max(valores) * 0.8, f'Total: {total_registros} usuarios', 
...
plt.title('🎂 DISTRIBUCIÓN POR EDAD\n(252 usuarios con fecha)', fontweight='bold')
