...
'''
    ...
    # Encontrar la sección donde se mapea circunscripcion y reemplazarla completa
    # Buscar desde "let circunscripcion = 'PRIMERA_CIRCUNSCRIPCION'"
    pattern = r'(let circunscripcion = \'PRIMERA_CIRCUNSCRIPCION\';.*?)(      })'
    
    replacement = r'''const circunscripcion = mapearCircunscripcionReal(inscription);
      \2'''
...
if __name__ == "__main__":
    print("🔧 ACTUALIZANDO SEARCH ENDPOINT V2")
    print("=" * 50)
